...
export default function ReservationMobileFooter({
  ...
  return (
    <div className='fixed bottom-0 left-0 w-full px-4 pb-4 z-50 bg-transparent'>
      <div className='w-full h-[64px] px-[8px] bg-white rounded-full border border-gray-200 shadow-[0px_4px_40px_0px_rgba(0,0,0,0.10)] backdrop-blur-md flex items-center'>
        {/* 좌측: 텍스트 */}
        ...
        <div className='ml-auto'>
          <BaseButton
            ...
            className='w-[100px] h-[48px] text-lg font-bold rounded-full transition'
          >
            일정 선택
          </BaseButton>
        </div>
