...
const LABEL_STYLE_MAP = {
  '예약 완료': { bg: 'bg-green-100 dark:bg-green-900', text: 'text-green-200' },
  '예약 취소': { bg: 'bg-gray-100 dark:bg-gray-700', text: 'text-gray-600 dark:text-gray-400' },
  '예약 거절': { bg: 'bg-red-100 dark:bg-red-900', text: 'text-red-300' },
  '예약 승인': { bg: 'bg-blue-100 dark:bg-blue-900', text: 'text-blue-200' },
  '체험 완료': { bg: 'bg-purple-100 dark:bg-purple-900', text: 'text-purple-200' },
};
