          ...
          <ul className='flex flex-col gap-[24px]'>
            {notificationData?.notifications?.map(
              ({ id, content, createdAt }: NotificationItem) => (
                ...
                >
                  <div
                    className={`${content.includes('승인') ? 'bg-blue-100 dark:bg-dark-blue-200 text-blue-200 dark:text-blue-100' : 'bg-red-100 dark:bg-dark-red-200 text-red-200 dark:text-red-100'} flex items-center justify-center rounded-full px-[10px] py-[6px] w-fit h-fit`}
                  >
